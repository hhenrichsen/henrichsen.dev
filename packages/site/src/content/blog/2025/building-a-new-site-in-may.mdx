...
```tsx motion-canvas caption="Example Animation"
import { Circle, makeScene2D } from "@motion-canvas/2d";
import { Color, createRef, useScene, loop, beginSlide, cancel } from "@motion-canvas/core";
import { getColors } from "virtual:motion-canvas-colors";
